...
import com.awesome.testing.performance.javabenchmark.generated.ExplainingState_jmhType;
import com.awesome.testing.performance.javabenchmark.generated.ExplainingState_PredefinedState_jmhType;
public final class ExplainingState_testMethod_jmhTest {
    ...
    public BenchmarkTaskResult testMethod_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            ExplainingState_jmhType l_explainingstate0_0 = _jmh_tryInit_f_explainingstate0_0(control);
            ExplainingState_PredefinedState_jmhType l_predefinedstate1_1 = _jmh_tryInit_f_predefinedstate1_1(control);

            control.preSetup();
            l_predefinedstate1_1.doIterationSetup();


            control.announceWarmupReady();
            while (control.warmupShouldWait) {
                l_explainingstate0_0.testMethod(l_predefinedstate1_1);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            testMethod_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_predefinedstate1_1, l_explainingstate0_0);
            ...
            l_predefinedstate1_1.doIterationTeardown();

            if (control.isLastIteration()) {
                f_predefinedstate1_1 = null;
                f_explainingstate0_0 = null;
            }
    ...
    public static void testMethod_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, ExplainingState_PredefinedState_jmhType l_predefinedstate1_1, ExplainingState_jmhType l_explainingstate0_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult testMethod_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            testMethod_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_predefinedstate1_1, l_explainingstate0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult testMethod_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            testMethod_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_predefinedstate1_1, l_explainingstate0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void testMethod_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, ExplainingState_PredefinedState_jmhType l_predefinedstate1_1, ExplainingState_jmhType l_explainingstate0_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult testMethod_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            testMethod_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_predefinedstate1_1, l_explainingstate0_0);
            control.preTearDown();
            l_predefinedstate1_1.doIterationTeardown();
    ...
    ExplainingState_jmhType f_explainingstate0_0;
    
    ExplainingState_jmhType _jmh_tryInit_f_explainingstate0_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        ExplainingState_jmhType val = f_explainingstate0_0;
        if (val == null) {
            val = new ExplainingState_jmhType();
            f_explainingstate0_0 = val;
        }
        return val;
    }
    
    ExplainingState_PredefinedState_jmhType f_predefinedstate1_1;
    
    ExplainingState_PredefinedState_jmhType _jmh_tryInit_f_predefinedstate1_1(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        ExplainingState_PredefinedState_jmhType val = f_predefinedstate1_1;
        if (val == null) {
            val = new ExplainingState_PredefinedState_jmhType();
                Field f;
                f = com.awesome.testing.performance.javabenchmark.ExplainingState.PredefinedState.class.getDeclaredField("a");
                f.setAccessible(true);
                f.set(val, Integer.valueOf(control.getParam("a")));
                f = com.awesome.testing.performance.javabenchmark.ExplainingState.PredefinedState.class.getDeclaredField("b");
                f.setAccessible(true);
                f.set(val, Integer.valueOf(control.getParam("b")));
            val.doForkSetup();
            f_predefinedstate1_1 = val;
        }
        return val;
    }
